...
**New to InvestorClaw?** The fastest path is the prebuilt container — see **[Getting Started](docs/GETTING_STARTED.md)**: `docker pull ghcr.io/argonautsystems/ic-engine:4.7.1-cpu`, mount a portfolio CSV, done. No source build. Works with any market-data provider (free `yfinance` by default).

...
user-invocable: true
metadata: {"license":"MIT-0","version":"4.5.3","image":"ghcr.io/argonautsystems/ic-engine:4.6.0-cpu","mcp-endpoint":"http://localhost:18090/mcp","transport":"streamable-http"}
---
...
|---|---|---|---|
| Image extract | 5–30 s | First-time pull of `ic-engine:4.6.0-cpu` (~600 MB) | docker compose progress bars |
...
- Image: `ghcr.io/argonautsystems/ic-engine:4.6.0-cpu` (multi-arch amd64+arm64; also at `:latest`)

...
2. Then ask Claude:
   ...
   Claude runs the skill's setup, which **pulls `ghcr.io/argonautsystems/ic-engine:4.5.1-cpu@sha256:d2b7275d62d50d8ff57af121286dc35e11cb0f33fa3aceced64835291e851bcc`**
...
```bash
docker pull ghcr.io/argonautsystems/ic-engine:4.5.1-cpu@sha256:d2b7275d62d50d8ff57af121286dc35e11cb0f33fa3aceced64835291e851bcc
```
...
docker run --rm \
  ...
  ghcr.io/argonautsystems/ic-engine:4.5.1-cpu@sha256:d2b7275d62d50d8ff57af121286dc35e11cb0f33fa3aceced64835291e851bcc holdings
```
...
docker run --rm -p 18090:8090 -p 18092:8092 \
  -e INVESTORCLAW_PRICE_PROVIDER=massive \
  -v "$PWD/ic-data:/data" \
  ghcr.io/argonautsystems/ic-engine:4.5.1-cpu@sha256:d2b7275d62d50d8ff57af121286dc35e11cb0f33fa3aceced64835291e851bcc

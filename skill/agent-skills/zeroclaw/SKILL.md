...
user-invocable: true
metadata: {"license":"MIT-0","version":"4.7.2","runtime":"zeroclaw","image":"ghcr.io/argonautsystems/ic-engine:4.7.2-cpu","mcp-endpoint":"http://localhost:18090/mcp"}
---
...
- `mnemos-os/ic-engine:4.7.2-cpu` → `localhost:18090`
